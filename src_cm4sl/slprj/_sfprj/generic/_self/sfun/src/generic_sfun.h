#ifndef __generic_sfun_h__
#define __generic_sfun_h__
...
extern mxArray* load_generic_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_generic_optimization_info(void);
